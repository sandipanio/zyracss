/**
 * Convenience methods module for generateCSS API
...
export async function generateCSSFromHTML(html, options = {}) {
  // Import the main generateCSS function to avoid circular imports
  const { generateCSS } = await import("../core/generateCSS.js");
