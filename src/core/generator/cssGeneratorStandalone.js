/**
 * Complete standalone CSS generation with no external imports
 * This should work without any hanging issues
 */

/**
 * Normalize CSS value (standalone version)
 */
function normalizeCSSValue(value) {
  ...
  // Handle numeric values without units (add px)
