...
/**
 * Get recommended limits for different input types
...
export function getRecommendedLimits() {
  return {
    className: {
      ...
      recommended: 100,
      description: "CSS class names should typically be under 100 characters",
    },
    cssValue: {
      max: MAX_VALUE_LENGTH,
      recommended: 50,
      description: "Simple CSS values should typically be under 50 characters",
    },
    classArray: {
      max: MAX_CLASSES_PER_REQUEST,
      recommended: 1000,
      description: "For better performance, keep class arrays under 1000 items",
    },
    totalSize: {
      max: 1024 * 1024,
      recommended: 100 * 1024,
      description: "Keep total input size under 100KB for optimal performance",
    },
  };
}
